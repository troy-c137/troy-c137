...
### I’m a mission-driven engineer and US Army Soldier bridging full-stack product engineering and tactical communications (SATCOM/radio). I’ve shipped production software end-to-end (database → backend → frontend → AWS deployments), and I currently serve in the WV National Guard as a 25S Satellite Communication Systems Specialist employing encrypted comms for operational detachments.
